...
metron, measure." In the article, Large provides examples (including
late blight of potato and choke of cocksfoot) where the new science of
phytopathometry was a basis for obtaining valuable information from
...
pathology-related areas of science. Based on the history of
phytopathometry, its application, and the statements quoted from Large
...
earlier (Nutter et al. 1991). The 1991 glossary was proposed after the
...
diseased characteristics. Thus, we contend that disease measurement
...
This definition
differs from most prior definitions that described severity purely on
...
phytopathometry. This glossary includes 128 terms, which is an increment
